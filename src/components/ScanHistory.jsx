    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex-1 relative group">
            <Input
              ...
              className="pr-10 h-10 text-sm px-4 bg-background/50 border-border/50 focus:border-purple-500/50 focus:ring-purple-500/20 transition-all"
            />
            <Search className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-focus-within:text-purple-400 transition-colors" />
          </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
          ...
          <div className="flex gap-1.5 flex-wrap p-1.5 bg-background/30 backdrop-blur-sm rounded-xl border border-border/50">
            <button
              onClick={() => {
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center gap-1.5 ${
                filterClassification === 'suspicious'
                  ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/40 shadow-lg shadow-yellow-500/10'
                  : 'text-muted-foreground hover:text-foreground hover:bg-white/5'
              }`}
            >
          ...
          {uniqueScamTypes.length > 0 && filterClassification === 'scam' && (
            <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <select
                ...
                className="bg-transparent text-sm text-foreground outline-none cursor-pointer min-w-[150px]"
              >
      ...
      {filteredScans.length > 0 && (
        <div className="flex justify-between items-center mt-6 pt-4 border-t border-border/30">
          ...
          <Button
            ...
            className="flex items-center gap-2 h-9 px-4 bg-background/50 border-border/50 hover:bg-purple-500/10 hover:border-purple-500/30 hover:text-purple-400 transition-all"
          >
