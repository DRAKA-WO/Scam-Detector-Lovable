...
function SignupModal({ isOpen, onClose, onSignup, remainingChecks = 0 }) {
  const features = [
    "Unlimited analysis",
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 max-w-md w-full overflow-hidden relative">
        {/* Close button */}
        <button
          onClick={onClose}
