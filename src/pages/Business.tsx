...
const FloatingDiamond = ({ className, delay = 0 }: { className?: string; delay?: number }) => (
  <motion.div
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <div className="relative w-full max-w-md aspect-square">
                ...
                />
                <motion.div 
                  className="absolute inset-4 rounded-3xl border border-purple-500/15"
                  animate={{ 
                    scale: [1, 1.03, 1],
                    opacity: [0.2, 0.4, 0.2]
                  }}
                ...
                <div className="absolute inset-8 rounded-2xl bg-card/80 border border-border flex items-center justify-center">
                  <div className="text-center p-6">
                    <motion.div 
                      className="w-20 h-20 mx-auto mb-4 rounded-2xl gradient-button flex items-center justify-center"
                      animate={{ 
                        boxShadow: [
        ...
        <section className="py-12 border-y border-border bg-card/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
              {["TechCorp", "FinanceHub", "SecureBank", "TrustNet", "SafePay"].map((name, index) => (
                <motion.div 
                  key={name} 
                  initial={{ opacity: 0, y: 20 }}
                  ...
                  className="text-lg sm:text-xl font-display font-bold text-muted-foreground/50 cursor-default"
                >
                  {name}
                </motion.div>
              ))}
      ...
      <section className="py-20 sm:py-28 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8" staggerDelay={0.15}>
            ...
            <StaggerItem>
              <motion.div 
                className="feature-card rounded-2xl p-8 h-full"
                whileHover={{ y: -8, transition: { duration: 0.3 } }}
              >
                <motion.div 
                  className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 flex items-center justify-center mb-6"
            ...
            <StaggerContainer className="grid sm:grid-cols-2 gap-6" staggerDelay={0.1}>
              {[
                ...
                <StaggerItem key={index}>
                  <motion.div 
                    className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-border h-full"
                    whileHover={{ 
                  ...
                  >
                    <motion.div 
                      className="w-12 h-12 rounded-lg bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 flex items-center justify-center mb-4"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6" staggerDelay={0.1}>
            {[
              ...
              <StaggerItem key={index}>
                <motion.div 
                  className="text-center p-6 rounded-xl bg-card/30 border border-border h-full"
                  whileHover={{ 
                    borderColor: "hsl(var(--primary) / 0.3)",
                    y: -6,
                    transition: { duration: 0.2 }
      ...
      <section id="contact" className="py-20 sm:py-28 bg-gradient-to-b from-card/50 to-background border-t border-border relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <AnimatedSection className="max-w-3xl mx-auto text-center">
            <motion.div 
              className="w-16 h-16 mx-auto mb-8 rounded-2xl gradient-button flex items-center justify-center"
              animate={{ 
                boxShadow: [
                  "0 0 20px rgba(168, 85, 247, 0.3)",
                  "0 0 40px rgba(168, 85, 247, 0.5)",
