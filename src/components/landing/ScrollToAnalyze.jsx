...
function ScrollToAnalyze() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-20 right-6 z-50 gradient-button text-primary-foreground px-5 py-3 rounded-full font-semibold shadow-lg flex items-center gap-2 transition-all duration-300 hover:scale-105 ${
