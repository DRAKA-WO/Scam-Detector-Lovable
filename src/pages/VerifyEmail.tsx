...
/**
 * Shown after email sign-up from /extension-auth. Tells user to check email
 * and to check the extension popup after confirming.
 */
const VerifyEmail = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="text-base text-foreground font-medium mb-10 rounded-lg bg-primary/10 border border-primary/20 px-4 py-3">
          After you confirm your email, open the <strong>Scam Checker extension popup</strong>—you'll be signed in there too.
        </p>
        <Link
          to="/"
